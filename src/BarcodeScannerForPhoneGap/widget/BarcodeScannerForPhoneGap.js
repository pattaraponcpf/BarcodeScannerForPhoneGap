...
define([
    ...
    "dojo/_base/declare",
    "dojo/Text!BarcodeScannerForPhoneGap/widget/template/BarcodeScannerForPhoneGap.html"
], function(
    _WidgetBase, 
    mxuiDom, 
    dojoClass, 
    ...
    return declare("BarcodeScannerForPhoneGap.widget.BarcodeScannerForPhoneGap", [_WidgetBase, _TemplateMixin], {
